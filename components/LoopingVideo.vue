<template>
    <div class="bigger videoContainer">
        ...
        <button @click="muted = !muted">does it work if this is a button?</button>

        <div class="audioButton" @click="muted = !muted" v-if="!safari">
...
export default {
    ...
    mounted() {
        this.safari = typeof navigator !== 'undefined' && /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
    }
};
</script>
