<template>
    <div class="bigger videoContainer">
        <video @click="muted = (!iOS ? !muted : true)" style="width: 100%;height: auto" id="loopingVideo" loop playsinline :muted="muted">
          <source :src="data.location" type="video/mp4">
        </video>

        <div class="audioButton" @click="muted = !muted" v-if="!iOS">
